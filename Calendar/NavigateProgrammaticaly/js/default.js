    ...
    app.onactivated = function (args) {
        if (args.detail.kind === activation.ActivationKind.launch) {
            ...
            args.setPromise(WinJS.UI.processAll().then(function() {
                calendar = document.getElementById("calendar").winControl;
                picker = document.getElementById("picker").winControl;

                navigateBtn.addEventListener("click", function () {
                    calendar.navigate(picker.value, "month");
                });

                navigateDownBtn.addEventListener("click", function () {
                    calendar.navigateDown(picker.value);
                ...
                navigateUpBtn.addEventListener("click", function () {
                    calendar.navigateUp(new Date(2001, 0, 1));
                    if (calendar.view.name == "century") {
